...
public class PersonaBean {
    ...
    public PersonaBean(String nome, String cognome, String telefono, String email, String password, TipoPersona tipoPersona) throws ValidazioneException{
        validaNome(nome);
        validaCognome(cognome);
        validaEmail(email);
        validaPassword(password);
        validaTipoPersona(tipoPersona);
    ...
    public PersonaBean(String email, String password) throws ValidazioneException {
        validaEmail(email);
        validaPassword(password);
    ...
    private void validaCognome(String cognome) throws ValidazioneException{
    ...
    private void validaEmail(String email) throws ValidazioneException{
    ...
    private void validaTipoPersona(TipoPersona tipoPersona) throws ValidazioneException{
        if (tipoPersona == null) {
